use bevy::{
    prelude::{BuildChildren, ButtonBundle, Commands, Component, NodeBundle, Res, TextBundle},
    text::{BreakLineOn, Text, TextAlignment, TextSection, TextStyle},
    ui::{AlignItems, FlexDirection, JustifyContent, Size, Style, UiRect, Val},
};

use crate::state::{
    assets::FontAssets,
    colours::{BORDER_COLOUR, BUTTON_COLOUR, INNER_COLOUR, TEXT_COLOUR},
};
